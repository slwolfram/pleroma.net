...
var G__37886 = o;
goog.object.set(G__37886,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__37918__delegate = function (args){
...
return G__37918__delegate.call(this,args);};
...
return G__37918__delegate(args);
});
...
var G__37889 = o;
goog.object.set(G__37889,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__37921__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__37926__i < G__37926__a.length) {G__37926__a[G__37926__i] = arguments[G__37926__i + 0]; ++G__37926__i;}
  args = new cljs.core.IndexedSeq(G__37926__a,0,null);
} 
return G__37921__delegate.call(this,args);};
G__37921.cljs$lang$maxFixedArity = 0;
G__37921.cljs$lang$applyTo = (function (arglist__37927){
var args = cljs.core.seq(arglist__37927);
return G__37921__delegate(args);
});
...
var G__37890 = props;
var G__37890__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37890,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37890);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37890__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__37890__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__37891 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37891,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__37891;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__37892){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37893__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__37895_SHARP_){
...
var vec__37897 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37897,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37897,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37897,(2),null);
...
var temp__5739__auto___37960 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___37960 == null)){
} else {
var key_37961 = temp__5739__auto___37960;
(jsprops.key = key_37961);
}
...
var temp__5739__auto___37966 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___37966 == null)){
} else {
var key_37967 = temp__5739__auto___37966;
(jsprops.key = key_37967);
}
...
var G__37901 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__37901) : reagent.impl.template.as_element.call(null,G__37901));
} else {
var temp__5739__auto___37968 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___37968 == null)){
} else {
var key_37969 = temp__5739__auto___37968;
(jsprops.key = key_37969);
}
...
var G__37903 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__37903)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__37903)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq37904){
...
break;
default:
var G__37982 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__37982;
continue;
...
var ctx = ({});
var vec__37908 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37908,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37908,(1),null);
...
var G__37911 = (cljs.core.count(argv) - first_child);
switch (G__37911) {
case (0):
