 ...
 */
garden.units.convert = (function garden$units$convert(p__28205,right){
...
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28206__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28206__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__28208 = temp__5735__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28208,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28208,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28208,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28226__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__28227 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28227__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
...
while (G__28273__i < G__28273__a.length) {G__28273__a[G__28273__i] = arguments[G__28273__i + 2]; ++G__28273__i;}
  more = new cljs.core.IndexedSeq(G__28273__a,0,null);
} 
...
G__28275 = new cljs.core.IndexedSeq(G__28276__a,0,null);
}
return garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__28275);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28240__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__28241 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28241__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
...
var more = null;
if (arguments.length > 2) {
var G__28280__i = 0, G__28280__a = new Array(arguments.length -  2);
while (G__28280__i < G__28280__a.length) {G__28280__a[G__28280__i] = arguments[G__28280__i + 2]; ++G__28280__i;}
  more = new cljs.core.IndexedSeq(G__28280__a,0,null);
} 
...
var x = cljs.core.first(arglist__28281);
arglist__28281 = cljs.core.next(arglist__28281);
var y = cljs.core.first(arglist__28281);
var more = cljs.core.rest(arglist__28281);
...
var G__28282 = null;
if (arguments.length > 2) {
var G__28283__i = 0, G__28283__a = new Array(arguments.length -  2);
while (G__28283__i < G__28283__a.length) {G__28283__a[G__28283__i] = arguments[G__28283__i + 2]; ++G__28283__i;}
G__28282 = new cljs.core.IndexedSeq(G__28283__a,0,null);
}
return garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__28282);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var map__28250 = u(x);
var map__28250__$1 = (((((!((map__28250 == null))))?(((((map__28250.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28250.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28250):map__28250);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28250__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__28251 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28251__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__28285__delegate = function (x,y,more){
...
var G__28285 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__28286__i = 0, G__28286__a = new Array(arguments.length -  2);
while (G__28286__i < G__28286__a.length) {G__28286__a[G__28286__i] = arguments[G__28286__i + 2]; ++G__28286__i;}
  more = new cljs.core.IndexedSeq(G__28286__a,0,null);
} 
return G__28285__delegate.call(this,x,y,more);};
G__28285.cljs$lang$maxFixedArity = 2;
G__28285.cljs$lang$applyTo = (function (arglist__28288){
var x = cljs.core.first(arglist__28288);
arglist__28288 = cljs.core.next(arglist__28288);
var y = cljs.core.first(arglist__28288);
var more = cljs.core.rest(arglist__28288);
return G__28285__delegate(x,y,more);
});
...
var G__28290 = null;
if (arguments.length > 2) {
var G__28291__i = 0, G__28291__a = new Array(arguments.length -  2);
while (G__28291__i < G__28291__a.length) {G__28291__a[G__28291__i] = arguments[G__28291__i + 2]; ++G__28291__i;}
G__28290 = new cljs.core.IndexedSeq(G__28291__a,0,null);
}
return garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__28290);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28254__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__28255 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28255__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
...
var more = null;
if (arguments.length > 2) {
var G__28296__i = 0, G__28296__a = new Array(arguments.length -  2);
while (G__28296__i < G__28296__a.length) {G__28296__a[G__28296__i] = arguments[G__28296__i + 2]; ++G__28296__i;}
  more = new cljs.core.IndexedSeq(G__28296__a,0,null);
} 
...
var more = cljs.core.rest(arglist__28297);
...
var G__28298 = null;
if (arguments.length > 2) {
var G__28299__i = 0, G__28299__a = new Array(arguments.length -  2);
while (G__28299__i < G__28299__a.length) {G__28299__a[G__28299__i] = arguments[G__28299__i + 2]; ++G__28299__i;}
G__28298 = new cljs.core.IndexedSeq(G__28299__a,0,null);
}
return garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__28298);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
